...
$writer->update(["username"=>$data->username],$document1);
try{
    $sql = $conn->query("UPDATE `User` SET (`name`, `username`, `password`) VALUES ('$data->name', '$data->username','$hPass') WHERE username='$data->username';");
